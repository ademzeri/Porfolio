            ...
            <div class="grid grid-cols-1 md:grid-cols-2">
               ...
               <form ref={form} onSubmit={sendEmail} class="p-6 flex flex-col justify-center">
                  <div class="flex flex-col">
                     ...
                     <input required type="name" name="user_name" id="name" placeholder="Full Name" class="text-white w-100 mt-2 py-3 px-3 rounded-lg  bg-gray-800 border border-gray-700  font-semibold focus:border-indigo-500 focus:outline-none"></input>
                  </div>
                  <div class="flex flex-col mt-2">
                     <label for="email" class="hidden">Email</label>
                     <input required type="email" name="email" id="email" placeholder="Email" class="w-100 mt-2 py-3 px-3 rounded-lg  bg-gray-800 border border-gray-700 text-white font-semibold focus:border-indigo-500 focus:outline-none"></input>
                  </div>
                  <div class="flex flex-col mt-2">
                     <label for="message" class="hidden">Message</label>
                     <input required type="text"  name="message" id="message" placeholder="Your Message" class="w-100 mt-2 py-3 px-3 rounded-lg  bg-gray-800 border border-gray-700 text-white font-semibold focus:border-indigo-500 focus:outline-none"></input>
                  </div>
